...
const Projects = ({className}) => {
    ...
    const projects = [
        ...
        {
            name: "Staffingly, Inc",
            link: "https://staffingly.com/",
            active: "true",
            logo: "/img/projects/staffingly.svg"
        },
        {name: "Hie.li", link: "https://hie.li/", active: "true", height: "w-[115px]", logo: "/img/projects/hie-li.png"},
        {
            name: "Timeclock - EMS",
            link: "https://timeclock.staffingly.com/",
            active: "true",
            height: "w-[115px]",
            logo: "/img/projects/twopm.png"
        },
        {
            name: "Fitnation.pro",
            link: "https://fitnation.pro/",
            active: "true",
            logo: "/img/projects/fitnation-pro-logo.png"
        },
                ...
                <div>
                    ...
                    <div className={"sm:flex sm:flex-wrap sm:gap-8 sm:pt-2"}>
                        ...
                        {projects.length > 0 && projects.map((project, key) => {
                            return (
                                <div
                                    className={"sm:w-[220px] mb-6 border rounded-lg h-20 sm:h-32 p-8 flex justify-center items-center border-amber-400 shadow-md shadow-amber-400 hover:shadow-lg duration-200"}
                                    key={key}>
                                    <Link target="_blank" href={project.link}>
                                        {/*{project.name}*/}
                                        <div className={`invert rounded overflow-hidden ${cssBuilder(project)}`}>
                                            <Image width={0}
                                                   height={0}
                                                   sizes="100vw"
                                                   style={{width: '100%', height: 'auto', objectFit: 'cover'}}
                                                   src={project?.logo} alt={project.name + "-logo"}/>
                                        </div>
                                    </Link>
                                </div>
                            )
